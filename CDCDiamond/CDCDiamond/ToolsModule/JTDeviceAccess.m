...
//    dispatch_async_main_safe(^{
//        if (HttpRequestTool .networkStatus == AFNetworkReachabilityStatusReachableViaWiFi) {
//            if (result) {
//                result(YES);
//            }
//        }
//        else if (HttpRequestTool .networkStatus == AFNetworkReachabilityStatusReachableViaWWAN)
//        {
//            UIAlertController *alertController = [UIAlertController alertControllerWithTitle:nil message:tipMessage preferredStyle:UIAlertControllerStyleAlert];
