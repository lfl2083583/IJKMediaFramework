...
@interface RNWebViewController () <WKNavigationDelegate>
@property (nonatomic, strong) RNJSHandler * jsHandler;
...
-(void)initWKWebView
{
    ...
    _jsHandler = [[RNJSHandler alloc]initWithViewController:self configuration:configuration];
    
    CGRect f = self.view.bounds;
    if (self.navigationController && self.isHidenNaviBar == NO) {
        f = CGRectMake(0, 0, self.view.bounds.size.width, APP_Frame_Height - kStatusBarHeight -kTopBarHeight);
    }
